...
TRANSLATIONS = {
    # 📅 Événements complets (prioritaires)
    ...
    # Événements spécifiques récents
    ...
    "GO Battle Weekend": "Week-end de Combats GO",
    ...
    "Candy XL": "Bonbons XL",
    "Double Candy from Raids": "Bonbons doublés dans les Raids",
    "Double XP from Raids": "XP doublée dans les Raids",
    "Double Stardust from Raids": "Poussière d’étoiles doublée dans les Raids",
    "Egg Hatching Bonus": "Bonus d’éclosion",
    "Friendship XP x2": "XP d’amitié x2",
    "Hatch Distance 1/2": "Distance d’éclosion ÷2",
    "Increased Lucky Pokémon": "Plus de Pokémon chanceux",
    "Increased Legendary Raid Spawns": "Plus de Raids légendaires",
    "Increased Mythical Raid Spawns": "Plus de Raids fabuleux",
    ...
    "Shiny Chance Up": "Chance de Shiny augmentée",
    "Special Box Offer": "Offre spéciale en boutique",
    ...
    # 🔤 Mots génériques (fallback, utilisés seulement si pas de phrase complète)
    "and": "et",
    "in": "dans",
    "the": "le",
    "of": "de",
